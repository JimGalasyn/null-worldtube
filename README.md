...
| 17 | Newton's Constant and Rest-Frame Schrödinger Evolution from K<sub>7</sub> Graph-State Information Theory | [10.5281/zenodo.20025452](https://doi.org/10.5281/zenodo.20025452) | 55 |
...
- **22-row substrate-monism master table** — particle masses, α, G, m_e/m_Pl, Z-pole cross section, Klein–Nishina amplitude, muon-decay survival on real IBM Heron R2 hardware — all computed end-to-end from a small set of substrate primitives by one open-source library [`nwt-substrate`](https://github.com/JimGalasyn/nwt-substrate) (344/344 unit tests passing) with no row-specific tuning (Paper 19)
...
### Paper 19 reproducibility pipeline (analysis/)

Paper 19 (*Substrate Monism: One Algebra, Seven Vocabularies, All
Forces*) assembles the resulting substrate-monism thesis as a
single, computationally verified demonstration. It is the
"computational hypothesis" capstone: every entry of a 22-row master
table — particle masses, gauge couplings, α, σ at the Z pole, Γ_Z,
G, m_e/m_Pl, the Klein–Nishina amplitude, and a muon-decay survival
curve measured on real IBM Heron R2 hardware — is computed end-to-end
from the substrate primitives by the open-source companion library
[`nwt-substrate`](https://github.com/JimGalasyn/nwt-substrate)
(Zenodo concept DOI [10.5281/zenodo.20012027](https://doi.org/10.5281/zenodo.20012027),
v0.1.3 = [10.5281/zenodo.20041585](https://doi.org/10.5281/zenodo.20041585),
344/344 unit tests passing) with no row-specific tuning.

The Paper 19 supporting numerics decompose into a vacuum-energy
sub-program (V) and a voxel-space / projection sub-program (W). All
scripts are self-contained with checks printed at run time.

```bash
# V: vacuum-energy / cosmological-constant program
python3 analysis/nwt_paper19_V1_vacuum_energy.py
python3 analysis/nwt_paper19_V2_condensate_scale.py
python3 analysis/nwt_paper19_V4_bit_creation.py

# W1+W2: K_7 holographic stabilizer state + entanglement-distance metric
python3 analysis/nwt_paper19_W12_holographic_K7.py

# W3.1: phonon dispersion on d-dim hypercubic voxel lattice
python3 analysis/nwt_paper19_W3_phonon_dispersion.py

# W3.2: K_7 voxels with vertex-sharing gluing on FCC RD spacetime tissue
python3 analysis/nwt_paper19_W3_2_fcc_phonons.py
python3 analysis/nwt_paper19_W3_2b_k7_internal.py
python3 analysis/nwt_paper19_W3_2c_central_force.py
python3 analysis/nwt_paper19_W3_2c2_floppy_structure.py
python3 analysis/nwt_paper19_W3_2c3_gauge_field.py
python3 analysis/nwt_paper19_W3_2d_two_parameter.py

# W3.3: gluing-rule scan A through K (PSL(2,7), S_4, D_4 sub-decompositions,
# matter coupling, neutrino phase soliton, PMNS angles from K_8/Spin(8))
python3 analysis/nwt_paper19_W3_3_gluing_scan.py
python3 analysis/nwt_paper19_W3_3b_edge_gluing.py
python3 analysis/nwt_paper19_W3_3c_psl27.py
python3 analysis/nwt_paper19_W3_3d_S4_decomp.py
python3 analysis/nwt_paper19_W3_3e_eg_matter_coupling.py
python3 analysis/nwt_paper19_W3_3f_constructed_eg.py
python3 analysis/nwt_paper19_W3_3g_D4_subdecomp.py
python3 analysis/nwt_paper19_W3_3h_paper6_consolidation.py
python3 analysis/nwt_paper19_W3_3i_neutrino_phase_soliton.py
python3 analysis/nwt_paper19_W3_3j_neutrino_NLO_NNLO.py
python3 analysis/nwt_paper19_W3_3k_PMNS_from_K8.py

# W3.4: voxel-space → 3+1 spacetime projection
python3 analysis/nwt_paper19_W3_4_lorentz_alpha.py
```

The QED-lens Compton diagram (Paper 19 §4) is rendered by
`papers/figures/paper19_fig_qed_compton.py` via the
`nwt_substrate.qed.compton.diagrams.s_channel` interface; the §3
Poincaré sphere figure is generated by
`papers/figures/paper19_substrate_figures.py`.

## Repository Structure

```
null-worldtube/
├── papers/                             # All 19 papers (LaTeX + PDF)
├── simulations/
...
├── analysis/                           # Analysis scripts (Papers 6-19)
