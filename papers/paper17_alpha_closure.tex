...
\end{equation}
The bracket coefficients $\alpha/7$ and $3\alpha^2$ in the closed
form for $m_e/\mPl$ (\S\ref{sec:intro-contribution}) are exactly the
first two normalised moments of $H_{YY}$.  This converts a numerical
